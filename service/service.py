...
from plans_nd_tasks import get_plans, get_tasks, get_conversations, get_threads, get_posts, create_tasks,update_tasks, create_plans
from planner_groups import get_all_groups
from planner_users import get_all_users
from planner_buckets import get_all_buckets, get_buckets, create_buckets
...
@app.route('/auth', methods=['POST', 'GET','PATCH'])
@log_request
def auth_user():
    """
